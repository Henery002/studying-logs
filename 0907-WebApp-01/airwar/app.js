...
var canvasWidth = WIDTH;  //画布的宽480
var canvasHeight = HEIGHT; //画布的高650
...
function Sky(img){  //一张背景图，绘出两份
  ...
  this.draw = function(){  //绘制一遍天空
    ctx.drawImage(img,this.x1,this.y1,WIDTH,HEIGHT);
    ctx.drawImage(img,this.x2,this.y2,WIDTH,HEIGHT);
  }
